<!-- 
*** This README template is originally from the [Best-README-Template]
*** (https://github.com/othneildrew/Best-README-Template) repository by "othneildrew".
*** If you found this template helpful, please consider giving the original repository 
*** a ⭐ [here](https://github.com/othneildrew/Best-README-Template).
*** 
*** This version has been modified by "soonvro".
-->
...
<!-- SHOWCASE -->
<!-- Showcase Source: https://pixabay.com/gifs/newton-pendulum-toy-spheres-1119/ -->
<div align="center">
...
<details>
  ...
  <ul>
    ...
    <li><a href="#why-this-template">Why this Template?</a></li>
    <li><a href="#built-with">Built With</a></li>
    <li><a href="#structure--architecture">Structure &amp; Architecture</a></li>
...
Explain how to integrate the component or feature into a larger system.
